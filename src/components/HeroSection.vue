            ...
            <div
                ...
                <div class="lg:py-6">
                    ...
                    <p class="text-gray-300 pt-8 text-center lg:text-left mx-auto max-w-xl">
                        I'm a highly efficient and reliable professional who possesses a broad skill set for web
                        application development and an open-minded web developer who's ready for new challenges.
                        I have spent most of my career in web development-focused on backend frameworks.
                    </p>
                    <div class="flex items-center gap-3 pt-9 flex-col sm:flex-row sm:w-max sm:mx-auto lg:mx-0">
                        ...
                        <button
                            ...
                            <div
                                ...
                                <a href="https://drive.google.com/file/d/1ERYgvd4cZUejEDRZjlrmyBNT4Y4OSQ6T/view?usp=sharing"
                                    class="pl-2 text-primary" target="_blank"> Download resume</a>
                            </div>
                        </button>
                    </div>
                </div>
                <div class="lg:h-full md:flex">
                    <div
                        ...
                        <div
                            ...
                            <img src="@/assets/avatar.jpg" alt="Hero pic" width="500" height="auto" loading="lazy"
